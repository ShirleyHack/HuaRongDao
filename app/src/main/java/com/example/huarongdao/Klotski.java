...
public class Klotski extends SurfaceView implements SurfaceHolder.Callback {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        Log.i(TAG, "mCell调整后 height -> " + mCellHeight + "; width -> " + mCellWidth);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                Log.i(TAG, "整newTop:" + newTop + "  ; newLeft:" + newLeft + "touchId:" + touchedId);
                ...
                if (touchedId==1 && newTop==mCellWidth*3 && newLeft==mCellWidth) {
                    ...
                    builder.setTitle("恭喜你！").setMessage("成功通关！").setPositiveButton("ok", new DialogInterface.OnClickListener() {
                        @Override
